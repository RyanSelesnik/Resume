...
\end{itemize}
 ...
 \subheadSkip
\subheading{Sensor Measurement Analysis using MPI} 
\begin{itemize}
    \item Wrote a \href{https://github.com/RyanSelesnik/Big-data-project}{script} to compute statistical indicators for a given data set, generated by a sensor in an Inertial Measurement Unit (IMU) device. 
