...
\newcommand{\heading}[1]{
\makebox[0pt][l]{\large\bfseries\scshape\raggedright\hspace{2pt}#1}
...
\begin{center}
\textsc{\textbf{\Large Ryan Selesnik}}
...
\begin{mysection}{Skills}
    \textbf{Programming:} C/C\texttt{++}, Python, \textsc{Matlab}, Mathematica
...
\end{mysection}
\begin{mysection}{Notable Projects}
    
    \subheading{Final Year Investigation Project} \hfill \contentType{Machine Learning}
         
     \begin{itemize}
     \item Conducted an investigation into and developed a novel low--cost AI toy that can assist in Early Childhood Development. 
...
\begin{itemize}
    \item Collaborated with a team of five to develop \href{https://github.com/witseie-elen4010/2022-group-lab-001}{MultiWordle}, a multiplayer version of Wordle. The tech--stack included JavaScript, Express, HTML, CSS, GitHub Actions, and MongoDB. 
\end{itemize}
 \subheadSkip

 \subheading{Centipede\texttt{++}} \hfill \contentType{Software Development}
\begin{itemize}
    \item Collaborated with a team of two to develop the Centipede computer game in C\texttt{++}.
\end{itemize}
