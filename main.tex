...
\begin{mysection}{Skills}
    ...
    \generalInfoSkip
    \textbf{Electronics:} Microcontrollers, Oscilloscopes, Raspberry Pi
...
\begin{mysection}{Notable Projects}
    ...
    \subheading{Final Year Investigation Project} \hfill \contentType{Machine Learning}
     ...
     \begin{itemize}
     \item Conducted an investigation into and developed a low--cost AI toy that can assist in Early Childhood Development. 
